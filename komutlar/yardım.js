...
exports.run = async (client, message, args) => {
  ...
  .setDescription(`**Yardım Komutları: ⚔️ \n Ana Menü: 💡** \n Evolve botumuzun komut sayfasına hoşgeldiniz♥`)
...
collector.on('collect', (reaction, user) => {
    ...
    const kobscode = new Discord.MessageEmbed()
      .setColor("BLUE")
 .addField("**Yardım Komutları**", `\n**<a:ottoman778758782121541632:861726441795747851>e+**rütbe-ekle @rol davet = **Rütbe Ekler** \n**<a:ottoman778758782121541632:861726441795747851>e+**rütbeler = **Rütbeleri Gösterir 1 Den 10'a Kadar** \n**<a:ottoman778758782121541632:861726441795747851>e+**rütbe-sıfırla = **Rütbeyi Sıfırlar.** \n**<a:ottoman778758782121541632:861726441795747851>e+**davetleri-sıfırla = **Davetleri Sıfırlar.** \n**<a:ottoman778758782121541632:861726441795747851>e+**top = **Lider Tablosunu Gösterir.** \n*e+**davetlerim = **Davetlerinizi Gösterir.** \n**e+**bonus-ekle = **Bonus Ekler.** \n**e+**davet-kanal #kanal = **Davet Kanalını Ayarlar.** \n**e+**davet-kanal-sıfırla = **Davet Kanalını Sıfırlar.** \n**e+**sunucupp = **sunucu resmini atar.** \n**<e+**ototag = **ototag ayarlarsınız** \n**<e+**anime = **anime fotoğraf atar**`)
